...
public class MongoDBUtil {
     ...
     * @return
     */
    public static boolean createIndex(String mongoName, String collectionName, Bson index) {
        MongoDatabase database = mongoClientMap.get(mongoName).getDatabase(mongoDBMap.get(mongoName));
        database.getCollection(collectionName).createIndex(index);
        return true;
    }
     ...
     * @return
     */
    public static boolean updateListMap(String mongoName, String collectionName, Bson filter, Bson update) {
        MongoDatabase database = mongoClientMap.get(mongoName).getDatabase(mongoDBMap.get(mongoName));
     ...
     * @return
     */
    public static boolean updateSql(String mongoName, String sql) {
        List<Bson> filterList = new ArrayList<Bson>();
