...
public class FileUtil {
     ...
     * @return 文本列表
     */
    public static List<String> file2lines(String filePath) {
     ...
     * 读取资源文件字节流
     */
    public static InputStream resource2stream(String filePath) {
        return new FileUtil().readResourceStream(filePath);
    }

    public static byte[] resource2byte(String filePath) {
        return stream2byte(resource2stream(filePath));
    }

    public static String resource2string(String filePath) {
        return stream2string(resource2stream(filePath));
    }

    private InputStream readResourceStream(String filePath) {
